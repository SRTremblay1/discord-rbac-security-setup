# Discord RBAC & Infrastructure Hardening Framework

![Status](https://img.shields.io/badge/Status-WIP%20/%20MVP%20Included-orange)

A reproducible, security-first architecture for Discord servers utilizing **Role-Based Access Control (RBAC)** and the **Principle of Least Privilege (PoLP)**. 
